...
export const appConfig = {
  ...
  ai: {
    // Default AI model
    defaultModel: 'bedrock/us.amazon.nova-pro-v1:0',
    ...
    // Model display names
    modelDisplayNames: {
      'bedrock/us.amazon.nova-pro-v1:0': 'Nova Pro (Bedrock) ⭐',
      'bedrock/openai.gpt-oss-120b-1:0': 'GPT-oss 120B (Bedrock)',
      'bedrock/zai.glm-5': 'GLM-5 (Bedrock)',
