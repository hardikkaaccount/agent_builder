      ...
      try {
        ...
        try {
          ...
          if (sandbox.writeFile) {
            ...
            console.log(`[apply-ai-code] Calling writeFile for: ${file.path}`);
            console.log(`[apply-ai-code] File content length: ${fileContent.length} chars`);
            await sandbox.writeFile(file.path, fileContent);
            console.log(`[apply-ai-code] writeFile completed for: ${file.path}`);
          ...
          console.error(`[apply-ai-code] E2B file write error for ${file.path}:`, writeError);
          console.error(`[apply-ai-code] Error details:`, {
